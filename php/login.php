...
header('Location: admin/Editvilles/edit_ville.php');
}
else {
    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Connexion</h1>
                   <p>Vous n'avez pas de mot de passe ?<a class="white" href="../register.php">S'enregistrer</a></p>
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form class="form" method="post" action="">
                            ...
                            <button class="form-control-submit-button" type="submit" name="form_connect">Se connecter</button>
                        </form>
